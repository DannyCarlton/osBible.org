...
/*************************************************************************************
 * 
 * 	This script is to demonstrate how to accpet a keyword query and return the text of the verse.
 * 		NOTE: We will only be doing a verse reference. Using a word as the keyword to find verses 
 * 		with that word will be a future script
 * 
 ***************************************************************************************/
...
$BookData=getBookByKeyword($keyword);
